...
class GUI:
    ...
    def __initialize_gui(self):
        ...
        self.cols_rect = self.cols_text.get_rect(
            center=(self.width - (self.width / 4), 175)
        )
        ...
        self.bfs_button = Button(
            ...
            pos=(self.width / 3, 375),
            text_input="BFS",
            font=self.__get_font(75),
            base_color="#d7fcd4",
        ...
        self.greedy_button = Button(
            image=pygame.image.load("Play Rect.png"),
            pos=(self.width - 550, 525),
            text_input="Greedy",
            font=self.__get_font(50),
            base_color="#d7fcd4",
            hovering_color="Green",
        )
        ...
        self.instructions_button = Button(
            ...
            pos=(self.width / 3, 675),
            text_input="Instructions",
            font=self.__get_font(30),
            base_color="#d7fcd4",
        ...
        self.back_from_instructions_button = Button(
            image=pygame.image.load("Quit Rect.png"),
            pos=(self.width - 225, self.height // 2),
            text_input="Back",
            font=self.__get_font(75),
            base_color="#d7fcd4",
            hovering_color="#03bafc",
        )
    ...
    def __show_instructions(self):
        while True:
            ...
            self.instructions_title_text = self.__get_font(32).render(
                instructions_text[0], True, "#de892f"
            )
            self.instructions_title_rect = self.instructions_title_text.get_rect(
                center=(self.width / 4 + 320, 75)
            )
            ...
            last_text_surface = font_body.render(
                instructions_text[-1], True, pygame.Color("#de892f")
            )
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if self.back_from_instructions_button.check_for_input(
    ...
    def main_menu(self):
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if self.input_rows.collidepoint(event.pos):
                        ...
                        active_rows = False
                    color_rows = (
                        color_active_rows if active_rows else color_inactive_rows
                    )
                    ...
                    if self.input_cols.collidepoint(event.pos):
                        ...
                        active_cols = False
                    color_cols = (
                        color_active_cols if active_cols else color_inactive_cols
                    )
            ...
            self.screen.blit(
                text_surface_rows, (self.input_rows.x + 5, self.input_rows.y + 5)
            )

            text_surface_cols = font.render(text_cols, True, pygame.Color("White"))
            pygame.draw.rect(self.screen, color_cols, self.input_cols, 2)
            self.screen.blit(
                text_surface_cols, (self.input_cols.x + 5, self.input_cols.y + 5)
            )

            pygame.display.update()

    def show_new_back_button(self):
        self.back_from_algorithm_button = Button(
            image=pygame.image.load("Quit Rect.png"),
            pos=(self.width - 225, 200),
            text_input="Back",
            font=self.__get_font(50),
            base_color="#d7fcd4",
            hovering_color="#03bafc",
        ...
        while True:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    exit()
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if self.back_from_algorithm_button.check_for_input(
                        pygame.mouse.get_pos()
                    ):
                        return
